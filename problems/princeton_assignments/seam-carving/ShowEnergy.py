...
if __name__ == "__main__":
    # filename = sys.argv[1]
    # filename = '/Users/sravan/Projects/ds_algo/problems/princeton_assignments/seam-carving/data/seam/10x10.png'
    filename = '/problems/princeton_assignments/seam-carving/data/images/img_01.jpg'
    main(filename)
